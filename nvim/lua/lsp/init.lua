...
M.on_attach = function(client, bufnr)
  ...
  M.mapper('i', '<c-k>', '<cmd>lua vim.lsp.buf.signature_help()<CR>')
  ...
  M.mapper('n', '<leader>dd', '<cmd>lua require"diagnostic".refresh_diagnostics()<CR>')
...
nvim_lsp.gopls.setup{
  ...
  on_attach = function(client, bufnr)
    ...
    vim.api.nvim_command('au BufWritePre *.go lua require"go_utils".organize_imports()')
    vim.api.nvim_command('au BufWritePre *.go lua require"go_utils".format_file()')
  end,
